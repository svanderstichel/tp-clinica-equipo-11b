...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-flex justify-content-center align-items-start pt-5">
        <div class="card shadow p-4" style="width: 22rem;">
            ...
            <div class="mb-3">
                <label for="txtidTurnoTrabajo" class="form-label">Id Turno</label>
                <asp:TextBox runat="server" ID="textBox5" cssClass="form-control" placeholder="Ingrese el Id del turno"></asp:TextBox>
                <asp:RequiredFieldValidator CssClass="validacion" ErrorMessage="El Id del turno es requerido" ControlToValidate="textBox5" runat="server" />
            </div>
            <div class="mb-3">
